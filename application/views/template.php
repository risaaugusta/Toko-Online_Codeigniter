  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/jannah/dashboard')?>" class="logo"><b> جنّة Store</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/jannah/dashboard')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/jannah/toko')?>" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/Jannah')?>">Data Barang</a></li>
